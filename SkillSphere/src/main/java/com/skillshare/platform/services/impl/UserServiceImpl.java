...
import com.skillshare.platform.util.EmailService;
...
public class UserServiceImpl implements UserService {
    ...
    @Override
    public void genaratePasswordResetToken(String email) {
    ...
    public void resetPassword(String token, String newPassword) {
        ...
        if (resetToken.isUsed())
            throw new RuntimeException("Password reset token already has been used");
    ...
    public List<UserDTO> getAllPublicProfiles(Long authenticatedUserId) {
        ...
        return users.stream()
                .filter(user -> !user.getUserId().equals(authenticatedUserId))
